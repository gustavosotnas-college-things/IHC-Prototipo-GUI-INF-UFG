jQuery("#simulation")
  .on("click", ".s-35aae497-b9b6-42bc-ae92-0c059546680d .click", function(event, data) {
          ...
          "blocks": [
            {
              ...
              "actions": [
                ...
                },
                {
                  ...
                  "parameter": [ {
                    "#s-35aae497-b9b6-42bc-ae92-0c059546680d #s-Botao_mouse_over_15": {
                      "attributes": {
                        "opacity": "0.5"
                      }
                    }
  ...
  .on("windowresize", ".s-35aae497-b9b6-42bc-ae92-0c059546680d .windowresize", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-35aae497-b9b6-42bc-ae92-0c059546680d")) {
      cases = [
        {
          "blocks": [
            {
